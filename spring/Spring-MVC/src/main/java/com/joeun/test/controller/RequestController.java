...
public class RequestController {
	...
	// 다중 파일을 모조리 DTO에 담아버리기!
	@ResponseBody
	@RequestMapping("/file/multi")
	public String fileUploadBoard(Board board) throws IOException {		// public String fileUpload(@RequestParam("file") List<MultipartFile> fileList) throws IOException {
		logger.info("/request/file/multi");
		logger.info("uploadPath : " + uploadPath);
		logger.info(board.toString()); 
	...
	public String ajaxUpload(Board board) throws IOException{

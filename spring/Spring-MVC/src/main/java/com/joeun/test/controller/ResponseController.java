...
public class ResponseController {
	...
	public ResponseEntity<byte[]> responseFile(HttpServletResponse response) throws Exception {
		
		
		
		// 파일 경로
		String filePath = "E:\\TJE\\UPLOAD\\test.jpg";
		String fileNmae = "test.jpg";
		...
		headers.add("Content-Disposition","attachment; filename="+fileNmae);	//형식(첨부파일), 파일명(test.jsp)
		...
		try {
			...
			FileCopyUtils.copy(new FileInputStream("파일경로"), response.getOutputStream());

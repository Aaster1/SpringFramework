...
public class BoardController {
	...
	public String insertPro(Board board) throws Exception{
		...
		if(result<1) return "board/insert";
	...
	public String delete(int boardNo) throws Exception{
		...
		if(result<1) return "board/list";
		
		return "redirect:/board/list";
	}
	
	@PostMapping("/search")
	public String search(Option option, Model model) throws Exception{
		

		model.addAttribute("boardList",boardService.search(option));

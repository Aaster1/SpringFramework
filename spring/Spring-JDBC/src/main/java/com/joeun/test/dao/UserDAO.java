...
public class UserDAO {
	...
	public User login(User user) {
		...
		User loginUser = jdbcTemplate.queryForObject(sql, new RowMapper<User>() {
			@Override
			public User mapRow(ResultSet rs, int rowNum) throws SQLException {
				User user = new User();
				user.setUserNo( rs.getInt("user_no") );
	...
	public int insertAuth(UserAuth userAuth) {
		...
		return jdbcTemplate.update("INSERT INTO `user_auth` (user_id,auth) VALUES(?,?)", userAuth.getUserId(),userAuth.getAuth());
	}
